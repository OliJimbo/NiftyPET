...
html_theme_options = {
    'logo_only':
    False,  # if we have a html_logo below, this shows /only/ the logo with no title text
}
...
man_pages = [(master_doc, 'niftypet', 'NiftyPET Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'NiftyPET', 'NiftyPET Documentation', author, 'NiftyPET',
